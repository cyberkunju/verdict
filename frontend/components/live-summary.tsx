...
export function LiveSummary({
  ...
  const { scores, closestArchive, durationSeconds, recordingBlobUrl } = summary;
    ...
    >
      ...
      <header className="rounded-2xl border border-slate-200 bg-gradient-to-br from-white via-slate-50 to-white p-8 shadow-sm">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600">
          Below is a deterministic synthesis of your session: rPPG-derived heart-rate dynamics, voice
          jitter and pitch shifts, action-unit averages, and the four composite scores. Nothing was
          uploaded — all numbers were computed in your browser.
        </p>
      </header>
